...
|BZ-134504|csi.k8s| Added a new option to read a list of FC ports from env variable "FC_PORTS_LIST" .| This is fixed with `quay.io/hpestorage/hpe3parprimera-csp:v1.2.1` and will be part of next release of csi-driver.|
