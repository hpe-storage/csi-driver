...
func parseMountOption(input string) model.MountOption {
...
func (driver *Driver) createVolume(
	...
	// Create new volume
	if mountOptions != nil && len(mountOptions) > 0 {
		createOptions["mountOptions"] = mountOptions
	}
