...
// StorageV1Client is used to interact with features provided by the storage.hpe.com group.
type StorageV1Client struct {
	restClient rest.Interface
}

func (c *StorageV1Client) HPENodeInfos() HPENodeInfoInterface {
	return newHPENodeInfos(c)
}
